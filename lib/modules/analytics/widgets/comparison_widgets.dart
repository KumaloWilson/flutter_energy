...
class ComparisonSettingsCard extends StatelessWidget {
  const ComparisonSettingsCard({Key? key}) : super(key: key);
...
class DeviceComparisonCard extends StatelessWidget {
  const DeviceComparisonCard({Key? key}) : super(key: key);
...
class TimePeriodComparisonCard extends StatelessWidget {
  const TimePeriodComparisonCard({Key? key}) : super(key: key);
...
class EfficiencyComparisonCard extends StatelessWidget {
  const EfficiencyComparisonCard({Key? key}) : super(key: key);
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: colorInfo.color.withOpacity(0.1),
